...
@REM git push -f https://github.com/Shuaiwen-Cui/D2L-CSW.git main
git push -f https://github.com/Shuaiwen-Cui/D2L-CSW.git main
@REM git remote add origin https://github.com/Shuaiwen-Cui/D2L-CSW.git
